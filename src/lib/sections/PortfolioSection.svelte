  ...
  const products = [
    {
      name: 'Food design',
      description:
        'Producto enfocado al área de Food Design que cumple con la característica de ser funcional en tiempo limitado con el objetivo de reducir los desechos de obsolescencia programada.',
      image:
    ...
    },
    {
      ...
      image:
        'https://res.cloudinary.com/dkvtpo8w1/image/upload/c_fill,h_405,w_270/v1648783630/MJ%20Portafolio/Colgador%20rompecabezas/render_1.png',
    },
    {
      name: 'Nudo Gordiano',
      description:
